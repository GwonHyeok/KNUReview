...
public class RegistrationIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        // GCM Instance ID의 토큰을 가져오는 작업이 시작되면 LocalBroadCast 로 GENERATING 액션을 알려 ProgressBar 가 동작하도록 한다.
        ...
        // GCM Instance ID에 해당하는 토큰을 획득하면 LocalBroadCast 에 COMPLETE 액션을 알린다.
